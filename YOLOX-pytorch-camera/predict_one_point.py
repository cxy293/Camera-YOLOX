...
# ------------------新加的sift角点检测---------------
#             #----1.对校正rectifyImage后的图像灰度化
#             iml_rectified_l = cv2.cvtColor(iml_rectified_l, cv2.IMREAD_GRAYSCALE)
#             imr_rectified_r = cv2.cvtColor(imr_rectified_r, cv2.IMREAD_GRAYSCALE)
#             #----2.sift特征计算
#             sift = cv2.SIFT_create(600)
#             kp1, des1 = sift.detectAndCompute(iml_rectified_l, None)
#             kp2, des2 = sift.detectAndCompute(imr_rectified_r, None)
