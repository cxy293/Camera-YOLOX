...
if __name__ == "__main__":
    ...
    disp = cv2.normalize(ncc_d, ncc_d, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX,
                          dtype=cv2.CV_8U)
    cv2.imwrite("./yolo/left.jpg", img1)
    cv2.imwrite("./yolo/right.jpg", img2)
    cv2.imwrite("./yolo/depth.jpg", disp)
