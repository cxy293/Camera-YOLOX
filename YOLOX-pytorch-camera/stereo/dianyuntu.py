...
if __name__ == '__main__':
    ...
    string = 'Val'
    # 读取数据集的图片
    iml = cv2.imread('G://pycharm//study_code//LYD-Champion-Photo-Camera//yolov5+stereo//stereo//yolo//zuo//left%d.bmp' %i)
    #iml = cv2.imread('./stereo/yolo/zuo/%sleft%d.bmp' %(string,i) )  # 左图
    imr = cv2.imread('G://pycharm//study_code//LYD-Champion-Photo-Camera//yolov5+stereo//stereo//yolo//you//right%d.bmp' %i)
    #imr = cv2.imread('./yolo/you/%sright%d.bmp'%(string,i) ) # 右图
